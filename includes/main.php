 ...
 * @subpackage Patterns_Fitness/includes
 */
...
class Patterns_Fitness {
	...
	private function load_dependencies() {
		...
		require_once PATTERNS_FITNESS_PATH . 'includes/functions.php';

		/**The class responsible for defining all actions that occur in both admin and public area.*/
		require_once PATTERNS_FITNESS_PATH . 'includes/class-include.php';

		/**The class responsible for block bindings.*/
		require_once PATTERNS_FITNESS_PATH . 'includes/class-block-bindings.php';

		/* API */
		require_once PATTERNS_FITNESS_PATH . 'includes/api/index.php';

		/**The class responsible for defining all actions that occur in the admin area.*/
		require_once PATTERNS_FITNESS_PATH . 'admin/index.php';

		/** The class responsible for defining all actions that occur in the public-facing side of the site.*/
		require_once PATTERNS_FITNESS_PATH . 'public/index.php';
	}
}
