...
/**
 * Title: Post Meta
 * Slug: patterns-fitness/post-meta
 * Categories: posts
...
<p class="has-tertiary-color has-text-color" style="margin-bottom:0px"><?php esc_html_e( 'Posted :', 'patterns-fitness' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group" style="font-size:14px"><!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"0px"}}},"textColor":"tertiary"} -->
<p class="has-tertiary-color has-text-color" style="margin-bottom:0px"><?php esc_html_e( 'by :', 'patterns-fitness' ); ?></p>
<!-- /wp:paragraph -->
