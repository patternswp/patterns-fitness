...
/**
 * Title: Page Sitemap
 * Slug: patterns-fitness/page-sitemap
 * Post Types: page
...
<div class="wp-block-columns alignwide" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4} -->
			<h4 class="wp-block-heading"><?php esc_html_e( 'Pages', 'patterns-fitness' ); ?></h4>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4} -->
			<h4 class="wp-block-heading"><?php esc_html_e( 'Categories', 'patterns-fitness' ); ?></h4>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":4} -->
			<h4 class="wp-block-heading"><?php esc_html_e( 'Posts', 'patterns-fitness' ); ?></h4>
			<!-- /wp:heading -->
			...
			<div class="wp-block-query alignfull">
				...
				<div class="wp-block-group" style="margin-top: 0; margin-bottom: 0; padding-top: var(--wp--preset--spacing--60); padding-right: 0; padding-bottom: var(--wp--preset--spacing--40); padding-left: 0">
					<!-- wp:pattern {"slug":"patterns-fitness/pagination"} /-->
					<?php
