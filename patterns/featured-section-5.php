 ...
 * Slug: patterns-fitness/featured-section-5
...
?>
<!-- wp:group {"align":"full","style":{"layout":{"selfStretch":"fit","flexSize":""},"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"blockGap":"var:preset|spacing|40"}},"backgroundColor":"quaternary","layout":{"type":"constrained","contentSize":""}} -->
...
<!-- wp:pattern {"slug":"patterns-fitness/section-title-2"} /-->
...
<div class="wp-block-column is-vertically-aligned-center">
   ...
   <!-- wp:pattern {"slug":"patterns-fitness/card-4"} /-->
</div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/icon-9.png" style="object-fit:contain;width:80px"/></figure>
<!-- /wp:image -->
...
<h5 class="wp-block-heading alignwide has-base-color has-text-color has-medium-font-size"><?php esc_html_e( 'Heart Pumping', 'patterns-fitness' ); ?></h5>
<!-- /wp:heading -->
...
<div class="wp-block-group has-default-background-color has-background" style="border-radius:5px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
 ...
 <!-- wp:image {"width":"80px","scale":"contain","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|base"}}} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/icon-10.png" style="object-fit:contain;width:80px"/></figure>
<!-- /wp:image -->

<!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide"><!-- wp:heading {"level":5,"align":"wide","textColor":"base","fontSize":"medium"} -->
<h5 class="wp-block-heading alignwide has-base-color has-text-color has-medium-font-size"><?php esc_html_e( 'Tons of Equipment', 'patterns-fitness' ); ?></h5>
<!-- /wp:heading -->
...
<div class="wp-block-group has-default-background-color has-background" style="border-radius:5px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
 ...
 <!-- wp:image {"width":"80px","scale":"contain","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|base"}}} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/icon-11.png" style="object-fit:contain;width:80px"/></figure>
<!-- /wp:image -->

<!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide"><!-- wp:heading {"level":5,"align":"wide","textColor":"base","fontSize":"medium"} -->
<h5 class="wp-block-heading alignwide has-base-color has-text-color has-medium-font-size"><?php esc_html_e( 'Modern Equipment', 'patterns-fitness' ); ?></h5>
<!-- /wp:heading -->
